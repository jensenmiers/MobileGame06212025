...
// Player data for Fatal Fury: City of the Wolves
const ALL_PLAYERS = [
  "Terry Bogard", "Rock Howard", "Mai Shiranui", "Andy Bogard", "Joe Higashi",
  "Billy Kane", "Geese Howard", "Blue Mary", "Yamazaki", "Kim Kaphwan",
  "Hotaru", "Tizoc", "B. Jenet", "Gato", "Freeman",
  "Kain R. Heinlein", "Hokutomaru", "Jenny", "Kevin", "Sokaku"
];
