...
// Placeholder data for the MK1 leaderboard
const leaderboardData = [
  { username: "ScorpionMain", points: 98, rank: 1 },
  { username: "SubZeroPro", points: 92, rank: 2 },
  { username: "LiuKangFTW", points: 89, rank: 3 },
  { username: "RaidenPlayer", points: 86, rank: 4 },
  { username: "JohnnyCage", points: 83, rank: 5 },
  { username: "SonyaBlade", points: 80, rank: 6 },
  { username: "KanoMain", points: 77, rank: 7 },
  { username: "JaxBriggs", points: 74, rank: 8 },
  { username: "KungLaoSpin", points: 71, rank: 9 },
  { username: "KitanaFan", points: 68, rank: 10 }
];
    ...
    <div className="min-h-screen bg-gray-900 text-white p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8 text-center">
          ...
          <h2 className="text-2xl font-bold mb-2">Mortal Kombat 1</h2>
