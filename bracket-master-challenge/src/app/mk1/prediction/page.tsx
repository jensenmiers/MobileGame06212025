...
// Player data for Mortal Kombat 1
const ALL_PLAYERS = [
  "Scorpion", "Sub-Zero", "Liu Kang", "Raiden", "Johnny Cage",
  "Sonya Blade", "Kano", "Jax", "Kung Lao", "Kitana",
  "Mileena", "Shang Tsung", "Sindel", "Rain", "Fujin",
  "Sheeva", "Shao Kahn", "Kotal Kahn", "D'Vorah", "Erron Black"
];
